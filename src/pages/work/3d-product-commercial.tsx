...
export default function ThreeDProductCommercial() {
  return (
    <div className="bg-black text-white">
      <Head>
        <title>3D Product Commercial | Pixpea Studio</title>
      </Head>
      ...
      <div className="relative h-screen w-full overflow-hidden">
        ...
        <div className="absolute bottom-20 left-6 md:left-20 max-w-2xl">
          ...
          <h1 className="text-5xl md:text-8xl font-bold leading-none mb-4 uppercase tracking-tighter">
            3D Product Commercial
          </h1>
          <p className="text-lg md:text-xl text-gray-300 italic mb-8">
            "Cinematic product reveals. Premium lighting."
          </p>
        </div>
      </div>
        ...
        <div className="grid md:grid-cols-[1fr_2fr] gap-16 items-start">
          ...
          <div>
            <h2 className="text-4xl md:text-7xl font-semibold mb-8 tracking-tight leading-tight">
              Captivating product stories with{" "}
              <span className="text-gray-400 italic">
                3D animation.
              </span>
            </h2>
            <p className="text-gray-400 text-xl md:text-2xl leading-relaxed font-light">
              We specialize in creating premium product films that showcase every
              detail through high-end lighting, modeling, and animation.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="px-6 md:px-20 pb-32 flex justify-center">
        <div className="w-full md:w-2/3 lg:w-1/2">
          <ImageCard
            ...
            desc="High-fidelity 3D renders that highlight your product's unique features."
          />
        </div>
      </div>
    </div>
