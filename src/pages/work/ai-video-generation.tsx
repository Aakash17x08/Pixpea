...
export default function AIVideoGeneration() {
  return (
    <div className="bg-black text-white">
      <Head>
        <title>AI Video Generation | Pixpea Studio</title>
      </Head>
        ...
        <div className="grid md:grid-cols-[1fr_2fr] gap-16 items-start">
          ...
          <div>
            <h2 className="text-4xl md:text-7xl font-semibold mb-8 tracking-tight leading-tight">
              Creating content using{" "}
              <span className="text-gray-400 italic">
                artificial intelligence.
              </span>
            </h2>
            <p className="text-gray-400 text-xl md:text-2xl leading-relaxed font-light">
              We are building AI-powered video solutions that generate cinematic
      ...
      <div className="px-6 md:px-20 pb-32 flex justify-center">
        <div className="w-full md:w-2/3 lg:w-1/2">
          <ImageCard
            poster="/Internals_images/air2.jpeg"
            title="AI Generated Visuals"
            desc="Next-gen AI tools transforming storytelling and content creation."
          />
        </div>
      </div>
    </div>
