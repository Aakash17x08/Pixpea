...
export default function VideoEditing() {
  return (
    <div className="bg-black text-white">
      <Head>
        <title>Video Editing | Pixpea Studio</title>
      </Head>
      ...
      <div className="relative h-screen w-full overflow-hidden">
        ...
        <div className="absolute bottom-20 left-6 md:left-20 max-w-2xl">
          ...
          <p className="text-lg md:text-xl text-gray-300 italic mb-8">
            "Professional cuts. Seamless transitions."
          </p>
        </div>
      </div>
        ...
        <div className="grid md:grid-cols-[1fr_2fr] gap-16 items-start">
          ...
          <div>
            ...
            <p className="text-gray-400 text-xl md:text-2xl leading-relaxed font-light">
              We provide high-end video editing services that bring your footage
              to life with cinematic transitions, color grading, and sound
              design.
            </p>
          </div>
        </div>
      ...
      <div className="px-6 md:px-20 pb-32 flex justify-center">
        <div className="w-full md:w-2/3 lg:w-1/2">
          <ImageCard
            ...
            desc="Expert storytelling through precise pacing and visual flow."
          />
        </div>
      </div>
    </div>
